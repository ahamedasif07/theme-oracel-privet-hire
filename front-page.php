...
<section class="relative min-h-screen overflow-hidden">
  <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hero.jpg" alt="Luxury chauffeur vehicle on a wet city street at night"
       class="absolute inset-0 h-full w-full object-cover" width="1920" height="1200">
  <div class="absolute inset-0 bg-gradient-to-b from-ink/60 via-ink/70 to-ink"></div>
  <div class="absolute inset-0 bg-gradient-to-r from-ink/80 via-ink/20 to-transparent"></div>
  ...
  <div class="relative mx-auto flex min-h-screen max-w-7xl flex-col justify-center px-6 pt-32 pb-20 lg:px-10">
    <div class="animate-fade-up max-w-3xl">
      <div class="flex items-center gap-3">
        ...
        <span class="text-xs uppercase tracking-[0.36em] text-gold">Executive Private Hire &middot; Est. 2011</span>
      </div>
      ...
      <div class="mt-10 flex flex-wrap gap-4">
        <a href="<?php echo esc_url( home_url( '/booking/' ) ); ?>" class="inline-flex items-center gap-2 rounded-full btn-gold px-8 py-4">
          Book Now
        ...
        <a href="<?php echo esc_url( home_url( '/booking/' ) ); ?>" class="inline-flex items-center gap-2 rounded-full btn-ghost-gold px-8 py-4">Get Free Quote</a>
      </div>
      ...
      <div class="mt-14 grid max-w-2xl grid-cols-2 gap-x-6 gap-y-4 sm:grid-cols-4">
        ...
        <div class="flex items-center gap-3">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 shrink-0 text-gold" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
        ...
        <div class="flex items-center gap-3">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 shrink-0 text-gold" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 7c0-5.333-8-5.333-8 0"/><path d="M10 7v14"/><path d="M6 21h12"/><path d="M6 13h10"/></svg>
...
<section class="mx-auto max-w-7xl px-6 py-20 lg:px-10 lg:py-28">
  <div class="mb-14 max-w-3xl">
    ...
    <h2 class="mt-5 font-display text-3xl leading-tight text-foreground md:text-5xl">Chauffeur service, redefined for the discerning traveller.</h2>
    <p class="mt-5 text-base leading-relaxed text-muted-foreground md:text-lg">
      For over a decade, Oracle Private Hire has become the trusted name in premium ground transportation — combining an immaculate modern fleet, the finest professional drivers and unwavering commitment to punctuality.
    </p>
  </div>

  <div class="grid gap-14 lg:grid-cols-2 lg:items-center">
    <div class="relative overflow-hidden rounded-3xl border border-white/5">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/images/about.jpg" alt="Chauffeur opening luxury car door at airport" class="h-full w-full object-cover" loading="lazy" width="1400" height="1000">
    ...
    <div>
      ...
      <a href="<?php echo esc_url( home_url( '/about/' ) ); ?>" class="mt-8 inline-flex items-center gap-2 text-sm font-medium text-gold hover:gap-3 transition-all">
        Discover our story
        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
      </a>
    </div>
...
<div class="border-y border-white/5 bg-onyx/40">
  <section class="mx-auto max-w-7xl px-6 py-20 lg:px-10 lg:py-28">
    <div class="mb-14 mx-auto max-w-2xl text-center">
      ...
      <h2 class="mt-5 font-display text-3xl leading-tight text-foreground md:text-5xl">Every journey, elevated.</h2>
      <p class="mt-5 text-base leading-relaxed text-muted-foreground md:text-lg">
        From executive airport transfers to bespoke wedding transport, we tailor every ride to the standard our clients expect.
      </p>
    </div>
    ...
    <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
      ...
      foreach ($homeServices as $s): ?>
        <div class="glass-card group rounded-2xl p-7">
          <div class="grid h-12 w-12 place-items-center rounded-xl border border-gold/30 bg-gold/5 text-gold transition-all group-hover:bg-gold group-hover:text-ink">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><?php echo $iconSvg[$s['icon']]; ?></svg>
          </div>
          ...
          <a href="<?php echo esc_url( home_url( '/services/' ) ); ?>" class="mt-5 inline-flex items-center gap-2 text-xs uppercase tracking-[0.24em] text-gold transition-all hover:gap-3">
            Learn more
            <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
          </a>
        </div>
      <?php endforeach; ?>
    </div>
...
<section class="mx-auto max-w-7xl px-6 py-20 lg:px-10 lg:py-28">
  <div class="mb-14 max-w-3xl">
    ...
    <h2 class="mt-5 font-display text-3xl leading-tight text-foreground md:text-5xl">A modern fleet, meticulously maintained.</h2>
    <p class="mt-5 text-base leading-relaxed text-muted-foreground md:text-lg">
      Choose from executive saloons, spacious MPVs and prestige SUVs — every vehicle finished in black, with leather interiors and complimentary Wi‑Fi.
    </p>
  </div>
  ...
  <div class="grid gap-6 md:grid-cols-3">
    ...
    foreach ($homeFleet as $v): ?>
      <article class="group overflow-hidden rounded-3xl border border-white/5 bg-card transition-all hover:border-gold/40 hover:shadow-elegant">
        <div class="relative aspect-[4/3] overflow-hidden bg-ink">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/<?php echo $v['image']; ?>" alt="<?php echo $v['name']; ?>" loading="lazy" width="1400" height="900"
               class="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105">
          <span class="absolute left-4 top-4 rounded-full border border-gold/40 bg-ink/70 px-3 py-1 text-[10px] uppercase tracking-widest text-gold backdrop-blur"><?php echo $v['tag']; ?></span>
        </div>
        <div class="p-6">
          ...
          <div class="mt-4 flex flex-wrap gap-3 text-xs text-muted-foreground">
            <span class="inline-flex items-center gap-1.5"><svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 text-gold" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="2" x2="22" y1="12" y2="12"/><line x1="12" x2="12" y1="2" y2="22"/></svg> AC</span>
            <span class="inline-flex items-center gap-1.5"><svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 text-gold" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 13a10 10 0 0 1 14 0"/><path d="M8.5 16.5a5 5 0 0 1 7 0"/><path d="M2 8.82a15 15 0 0 1 20 0"/><line x1="12" x2="12.01" y1="20" y2="20"/></svg> Wi‑Fi</span>
            <span class="inline-flex items-center gap-1.5"><svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 text-gold" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m2 4 3 12h14l3-12-6 7-4-7-4 7-6-7zm3 16h14"/></svg> Leather</span>
          </div>
        </div>
      </article>
    <?php endforeach; ?>
  ...
  <div class="mt-12 text-center">
    <a href="<?php echo esc_url( home_url( '/fleet/' ) ); ?>" class="inline-flex items-center gap-2 rounded-full btn-ghost-gold px-8 py-3.5">
      View Full Fleet
      <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
    </a>
  </div>
...
<div class="border-y border-white/5 bg-onyx/40">
  <section class="mx-auto max-w-7xl px-6 py-20 lg:px-10 lg:py-28">
    <div class="mb-14 mx-auto max-w-2xl text-center">
      ...
      <h2 class="mt-5 font-display text-3xl leading-tight text-foreground md:text-5xl">Reasons discerning clients choose us.</h2>
    </div>
    <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6">
      ...
      foreach ($trust as $t): ?>
        <div class="glass-card flex flex-col items-center rounded-2xl p-6 text-center">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gold" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><?php echo $t['icon']; ?></svg>
...
<section class="mx-auto max-w-7xl px-6 py-20 lg:px-10 lg:py-28">
  <div class="mb-14 mx-auto max-w-2xl text-center">
    ...
    <h2 class="mt-5 font-display text-3xl leading-tight text-foreground md:text-5xl">Trusted by executives, families and travellers.</h2>
  </div>
  <div class="grid gap-6 md:grid-cols-3">
    <?php
    $testimonials = [
...
<section class="mx-auto max-w-7xl px-6 pb-24 lg:px-10">
  <div class="relative overflow-hidden rounded-3xl border border-gold/20 bg-gradient-to-br from-onyx to-ink p-10 md:p-16">
    ...
    <div class="relative grid gap-10 lg:grid-cols-2 lg:items-center">
      <div>
        <h2 class="font-display text-3xl md:text-5xl">Reserve your <span class="text-gradient-gold">chauffeur</span>.</h2>
        <p class="mt-4 max-w-md text-muted-foreground">Instant fixed-price quote in under a minute. Nationwide UK coverage, 24 hours a day.</p>
      </div>
      <div class="flex flex-col gap-3 sm:flex-row lg:justify-end">
        <a href="tel:+441234567890" class="inline-flex items-center justify-center gap-2 rounded-full btn-ghost-gold px-6 py-4">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 6.392 6.384"/></svg>
          Call Us
        </a>
        <a href="mailto:bookings@oracleprivatehire.co.uk" class="inline-flex items-center justify-center gap-2 rounded-full btn-ghost-gold px-6 py-4">
        ...
        <a href="<?php echo esc_url( home_url( '/booking/' ) ); ?>" class="inline-flex items-center justify-center gap-2 rounded-full btn-gold px-8 py-4">
          Book Now
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
        </a>
      </div>
